...
testthat::test_that("build_o_matrix accepts NULL value and return a matrix with entry 1 a dimenssion 1", {
  testthat::expect_equal(build_o_matrix(NULL), matrix(1, 1, 1))
})
